...
That's the [pit of success](https://blog.codinghorror.com/falling-into-the-pit-of-success/) I want to surround myself with, and I believe we, as a community, should embrace those "Better Developer Tools" whenever we can - as doing so will help the whole ecosystem make progress, one (better developer) tool at a time.
