...
That same day I also deployed my own blog, inspired by Dan Abramov's [overreacted.io](https://overreacted.io), and just like that, my personal site was live.
...
<Image
  alt={`Moshe Katz site with only one post titled "Hello World"`}
  src={`/static/images/why-a-personal-site/moshekatz-dev-hello-world.png`}
  width={478}
  height={483}
  priority
/>
...
2. **Sustain a content creation habit** - by purifying the "why" of a personal site and the principles I plan to follow in order to stay consistent over time.
...
- [tailwind](https://tailwindcss.com/) the open source project; [tailwind-ui](https://tailwindui.com/) as the paid service.

Here are some examples to open source projects being built in the open:
...
- [supabse](https://github.com/supabase/supabase) - the open source Firebase alternative.
- [moshekatz.dev](https://github.com/moshekatz/moshekatz.dev) - this site 😊.
...
inherently "dogfooded" - for instance, [React](https://www.youtube.com/watch?v=GW0rj4sNH2w) and [Tailwind](https://adamwathan.me/tailwindcss-from-side-project-byproduct-to-multi-mullion-dollar-business/) that actually powers the current version of this website.
